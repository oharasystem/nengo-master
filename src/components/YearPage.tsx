...
export const YearPage = (props: Props) => {
    const { year, currentYear, era, trivia, lang, dict, path, host, env } = props;
    ...
    return (
        <Layout title={title} description={description} lang={lang} dict={dict} path={path} host={host} env={env}>
