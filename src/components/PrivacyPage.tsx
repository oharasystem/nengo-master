...
export const PrivacyPage = (props: Props) => {
    ...
    const contactUrl = getBaseUrl(env, "/contact");
            ...
            <div class="flex-1 w-full relative overflow-y-auto bg-slate-50">
                <div class="min-h-full flex flex-col items-center justify-start pt-8 pb-12 px-4">
                    <div class="w-full max-w-3xl bg-white p-8 rounded-xl border border-slate-200 shadow-sm">
                        ...
                        <section class="mb-8">
                            <h2 class="text-xl font-bold text-slate-700 mb-3">1. 広告の配信について</h2>
                        ...
                        <section class="mb-8">
                            <h2 class="text-xl font-bold text-slate-700 mb-3">2. アクセス解析ツールについて</h2>
                            <p class="text-slate-600 leading-relaxed mb-4">
                        ...
                        <section class="mb-8">
                            <h2 class="text-xl font-bold text-slate-700 mb-3">3. 免責事項</h2>
                            <p class="text-slate-600 leading-relaxed mb-4">
                                当サイトで掲載している画像の著作権・肖像権等は各権利所有者に帰属致します。権利を侵害する目的ではございません。記事の内容や掲載画像等に問題がございましたら、各権利所有者様本人が直接下記のお問い合わせフォームよりご連絡下さい。確認後、対応させて頂きます。<br />
                        ...
                        <section class="mb-8">
                            <h2 class="text-xl font-bold text-slate-700 mb-3">4. 著作権について</h2>
                            <p class="text-slate-600 leading-relaxed mb-4">
                        ...
                        <section class="mb-8">
                            <h2 class="text-xl font-bold text-slate-700 mb-3">5. お問い合わせ</h2>
                            <p class="text-slate-600 leading-relaxed mb-4">
                                当サイトの個人情報の取扱に関するお問い合わせは、下記までご連絡ください。
                            </p>
                            <p class="text-slate-600 leading-relaxed mb-4">
                                <strong>お問い合わせフォーム</strong>： <a href="/contact" class="text-[#22215B] hover:underline">{contactUrl}</a>
                            </p>
                        </section>

                        <div class="mt-8 pt-4 border-t border-slate-100 text-sm text-slate-500 text-right">
                            <p><strong>制定日</strong>：2026年1月26日</p>
                            <p><strong>運営者</strong>：solooo.dev 管理人</p>
                        </div>
                    </div>
                </div>
            </div>
